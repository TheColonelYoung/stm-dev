...
## TinyUSB
For STM32L is required to enable USB power before USB initialization.
...
HAL handler should be called but is regenerated by CubeMX begind return, so it is OK.
```c++
